...
<body onload="onLoaderFunc()">
    ...
    <div class="copy-wthree w3ls-reg" style="margin: auto; padding-top: 0px;">
        <p>Bill money</p>
            <input type="text" id="" required style="width: 100%;">
        <div> 
            <br/>
            <a href="#"><button style="margin: auto;">Payment</button></a>
            <br/>
            <div style="padding-top: 20px; margin: auto;"><a href="index.jsp" style="color: white;">Go to home</a></div>
            
        </div>
    </div>
    <div class="copy-wthree">
        <p> Design by
            <a href="#" target="_blank">TiQM Company</a>
        </p>
    </div>
    <!-- js -->
